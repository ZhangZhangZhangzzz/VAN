...
static uint8_t              gimbal_can_send_data[8];//��̨����������ݻ�����
//static CAN_TxHeaderTypeDef  chassis_tx_message;
//static uint8_t              chassis_can_send_data[8];//���̵���������ݻ�����
...
/**
  ...
  */
/**
  * @brief          ���͵�����Ƶ�ѹ(0x205,0x206,0x207,0x208)
  * @param[in]      yaw: (0x205) 6020������Ƶ���, ��Χ [-25000~0~25000]
  * @param[in]      pitch: (0x206) 6020������Ƶ���, ��Χ [-25000~0~25000]
